...
public class BinaryGrassBlock extends BinarySpreadableBlock
        implements Fertilizable {
    public BinaryGrassBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        BlockState blockState = ModBlocks.BINARY_GRASS.getDefaultState();
