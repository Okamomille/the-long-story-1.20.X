...
public class BinaryTrunkPlacer extends TrunkPlacer {
    public static final Codec<BinaryTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, BinaryTrunkPlacer::new));

    public BinaryTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
