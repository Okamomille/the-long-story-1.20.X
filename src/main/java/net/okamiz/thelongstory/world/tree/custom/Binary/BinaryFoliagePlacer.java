...
public class BinaryFoliagePlacer extends FoliagePlacer {

/*public static final Codec<BinaryFoliagePlacer> CODEC = RecordCodecBuilder.create(binaryFoliagePlacerInstance ->
        fillFoliagePlacerFields(binaryFoliagePlacerInstance).and(Codec.intRange(0,12).fieldOf("height")
                .forGetter(instance -> instance.height)).apply(binaryFoliagePlacerInstance, BinaryFoliagePlacer::new));
    private final int height;

    public BinaryFoliagePlacer(IntProvider radius, IntProvider offset, int height) {
        super(radius, offset);
        this.height = height;
    }
*/
    ...
    public static final Codec<BinaryFoliagePlacer> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ...
            })).apply(instance, BinaryFoliagePlacer::new));

    public BinaryFoliagePlacer(int height, IntProvider offset, IntProvider radius) {
        super(radius, offset);
        this.height = height;
        this.radius = radius;
    }
